...
\vspace{0.2cm}
	...
	\begin{figure}
		...
		\begin{minipage}{0.45\textwidth}
			...
			\caption*{\textbf{TA: Michael McRae} \\ (Office hours: next week Tuesday 9am, after Wednesday)}
		\end{minipage}
	\end{figure}
...
\textbf{Computer labs:}
\begin{itemize}
	\item Weekly labs \textbf{starting week 3} (online intro next week) 
	\item You will learn how to analyse data using software called Stata
	\item Crucial for coursework (worth 30\% of overall grade)
	\item You will be assigned to a group and a time slot by the Department. Contact econsec@tcd.ie (\underline{not me or Mike}) if this needs to be changed (but must be good reason)
\end{itemize}
\vspace{0.5cm}
...
\framesubtitle{Causal questions}
	...
	\pause 
	\item ... and a \textit{counterfactual} component (how would things have been under a different treatment?)
	
	\pause
	\item e. g: what is the causal effect on your earnings of going to Trinity rather than UCD? 
		\begin{itemize}
			\item
			Descriptive Q: how much do Trinity students earn after graduation?
			% include figure showing trinity student earnings here if can 
			
			\item Counterfactual Q: how much would Trinity students have earned if they went to UCD?  
		\end{itemize}
